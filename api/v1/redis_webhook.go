...
//+kubebuilder:webhook:path=/mutate-myapp-dfy-io-v1-redis,mutating=true,failurePolicy=fail,sideEffects=None,groups=myapp.dfy.io,resources=redis,verbs=create;update,versions=v1,name=mredis.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-myapp-dfy-io-v1-redis,mutating=false,failurePolicy=fail,sideEffects=None,groups=myapp.dfy.io,resources=redis,verbs=create;update,versions=v1,name=vredis.kb.io,admissionReviewVersions=v1
